...
public class CraftActionPipelineArch {
    ...
    private CraftActionPipelineArch(Player player) {
        this.player = player;
    }

    public static CraftActionPipelineArch create(Player player) {
        return new CraftActionPipelineArch(player);
    }
     ...
     * @return
     */
    public CraftActionPipelineArch baseItem(ItemStack stack) {
    ...
    public CraftActionPipelineArch itemCount(int count) {
    ...
    public CraftActionPipelineArch allowEmptyModules(boolean allowed) {
        this.allowEmptyModules = allowed;
        return this;
    }

    public CraftActionPipelineArch failureMode(FailureMode mode) {
        this.failureMode = mode;
        return this;
    }

    public CraftActionPipelineArch setAutoCount(boolean autoCount) {
    ...
    public CraftActionPipelineArch add(
